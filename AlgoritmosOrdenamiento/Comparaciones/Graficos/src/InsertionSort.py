...
plt.plot(x1,y1*6,color="blue",label="InsertionSort en C++")
plt.plot(x2,y2*6,color="yellow",label="InsertionSort en  Java")
plt.plot(x3,y3*6,color="red",label="InsertionSort en  Python")

plt.legend()
plt.title('Algoritmo InsertionSort')
plt.xlabel('Cantidad de datos')
plt.ylabel('Tiempo de ejecucion (segundos)')
plt.text(240000,11000,r'$O(n^2)$', fontsize=12)
plt.show()